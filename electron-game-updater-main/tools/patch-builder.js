...
async function main() {
    ...
    if (isDifferential) {
        if (!gameConfig.patchUrls) gameConfig.patchUrls = [];
        chunkUrls.forEach(url => {
            if (!gameConfig.patchUrls.includes(url)) {
                gameConfig.patchUrls.push(url);
            }
        });
    ...
    console.log(`
=====================================================
 SUCCESS! Differential Patch Package Created
=====================================================
